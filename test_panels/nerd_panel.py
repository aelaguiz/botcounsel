panel = {
  "panel": {
    "name": "Futurescape: Visions of Tomorrow",
    "description": "A dynamic discussion panel that brings together leading minds in science fiction, scientific research, and communication. The panel aims to explore and discuss the implications, possibilities, and ethical considerations of futuristic technologies and societies depicted in science fiction literature. By combining expert insights with engaging dialogue, the panel seeks to deepen understanding of how these fictional narratives reflect and might shape our real-world future.",
    "goals": "To provide a platform for rich, multidisciplinary discussions that bridge the gap between science fiction and real-world scientific and ethical considerations; to inspire and educate the audience about the potential futures humanity might encounter; and to stimulate thought-provoking conversation about our role and responsibilities in shaping tomorrow."
  },
  "researcher": {
    "name": "Dr. Michio Kaku",
